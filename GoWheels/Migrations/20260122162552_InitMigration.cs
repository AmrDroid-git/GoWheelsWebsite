        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RateAverage = table.Column<float>(type: "real", nullable: true),
                    RatingsCount = table.Column<int>(type: "integer", nullable: false),
                    Constructor = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    RatedUserId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserRatings_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    RatedPostId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false),
                    Value = table.Column<float>(type: "real", nullable: false),
                    OwnerId = table.Column<string>(type: "character varying(128)", maxLength: 128, nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PostRatings_AspNetUsers_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PostRatings_Posts_RatedPostId",
                        column: x => x.RatedPostId,
                        principalTable: "Posts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostRatings_OwnerId",
                table: "PostRatings",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_PostRatings_RatedPostId",
                table: "PostRatings",
                column: "RatedPostId");

            migrationBuilder.CreateIndex(
                name: "IX_Posts_Constructor",
                table: "Posts",
                column: "Constructor");

            migrationBuilder.CreateIndex(
                name: "IX_Posts_ModelName",
                table: "Posts",
                column: "ModelName");
